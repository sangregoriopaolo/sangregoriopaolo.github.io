                ...
                u = {
                        ...
                        if ("undefined" != typeof t && null != t) {
                            ...
                            return e(o).each(function() {
                                ...
                                if (o.data(n)) {
                                    ...
                                    d[0] = V.call(this, d[0], "y"), d[1] = V.call(this, d[1], "x"), l.moveDragger && (d[0] *= s.scrollRatio.y, d[1] *= s.scrollRatio.x), l.dur = c, setTimeout(function() {
                    ...
                    disable: function(t) {
                        ...
                        return e(i).each(function() {
                            var i = e(this);
                            i.data(n) && (i.data(n), $.call(this, "remove"), _.call(this), t && k.call(this), E.call(this, !0), i.addClass(c[3]))
                        })
                    },
                    destroy: function() {
                        var t = h.call(this);
                        return e(t).each(function() {
                            ...
                            if (o.data(n)) {
                                ...
                                a.live && m(a.liveSelector || e(t).selector), $.call(this, "remove"), _.call(this), k.call(this), o.removeData(n), G(this, "mcs"), d.remove(), l.find("img." + c[2]).removeClass(c[2]), r.replaceWith(l.contents()), o.removeClass(i + " _" + n + "_" + s.idx + " " + c[6] + " " + c[7] + " " + c[5] + " " + c[3]).addClass(c[4])
                            }
                        })
                    }
                },
...
mejs.version = "2.18.2", mejs.meIndex = 0, mejs.plugins = {
        ...
        e.extend(mejs.MepDefaults, {
            ...
            buildstop: function(t, i, n, o) {
                ...
                e('<div class="mejs-button mejs-stop-button mejs-stop"><button type="button" aria-controls="' + s.id + '" title="' + s.options.stopText + '" aria-label="' + s.options.stopText + '"></button></div>').appendTo(i).click(function() {
                    o.paused || o.pause(), o.currentTime > 0 && (o.setCurrentTime(0), o.pause(), i.find(".mejs-time-current").width("0px"), i.find(".mejs-time-handle").css("left", "0px"), i.find(".mejs-time-float-current").html(mejs.Utility.secondsToTimeCode(0, t.options)),
                        i.find(".mejs-currenttime").html(mejs.Utility.secondsToTimeCode(0, t.options)), n.find(".mejs-poster").show())
                })
            }
        })
    }(mejs.$),
    ...
    function(e, t, i) {
        ...
        function n() {
            // var t = '<div id="op-panel"><div id="op-panel-btn"><i class="icon icon-settings"></i></div><div class="op-content"><div class="op-section"><div class="op-theme-skin op-btn-group"><button class="op-btn active" data-value="light">Light</button><button class="op-btn" data-value="dark">Dark</button><div class="op-btn-bar"><span class="op-btn-bar-line"></span></div></div></div><div class="op-section"><div class="op-theme-colors"><button class="ripple-centered" data-color="e83b35"><i class="icon icon-check"></i></button><button class="ripple-centered" data-color="e8676b"><i class="icon icon-check"></i></button><button class="ripple-centered" data-color="ec407a"><i class="icon icon-check"></i></button><button class="ripple-centered" data-color="8e45ae"><i class="icon icon-check"></i></button><button class="ripple-centered" data-color="673bb7"><i class="icon icon-check"></i></button><button class="ripple-centered" data-color="3f51b5"><i class="icon icon-check"></i></button><button class="ripple-centered" data-color="5d6cc1"><i class="icon icon-check"></i></button><button class="ripple-centered" data-color="1a77d4"><i class="icon icon-check"></i></button><button class="ripple-centered" data-color="07aaf5"><i class="icon icon-check"></i></button><button class="ripple-centered" data-color="56c8d2"><i class="icon icon-check"></i></button><button class="ripple-centered" data-color="27a79a"><i class="icon icon-check"></i></button><button class="ripple-centered" data-color="07cb79"><i class="icon icon-check"></i></button><button class="ripple-centered" data-color="8dc24c"><i class="icon icon-check"></i></button><button class="ripple-centered" data-color="ffde03"><i class="icon icon-check"></i></button><button class="ripple-centered" data-color="fec107"><i class="icon icon-check"></i></button><button class="ripple-centered" data-color="ff9801"><i class="icon icon-check"></i></button><br/><br/><hr/><button class="ripple-centered" data-color="d1a3a6"><i class="icon icon-check"></i></button><button class="ripple-centered" data-color="ffcfd3"><i class="icon icon-check"></i></button><button class="ripple-centered" data-color="fbbdd4"><i class="icon icon-check"></i></button><button class="ripple-centered" data-color="e2bfe7"><i class="icon icon-check"></i></button><button class="ripple-centered" data-color="c7ccea"><i class="icon icon-check"></i></button><button class="ripple-centered" data-color="83d5fb"><i class="icon icon-check"></i></button><button class="ripple-centered" data-color="b4e1dc"><i class="icon icon-check"></i></button><button class="ripple-centered" data-color="a7d9a8"><i class="icon icon-check"></i></button></div></div><div class="op-section"><div class="op-theme-headimg"><button class="op-btn-check"><span class="op-check"><i class="icon icon-check"></i></span> Show Header Background Image</button></div></div></div></div>';
    ...
    function(e) {
        ...
        function t() {
            ...
            A || (t.appear(), t.on("appear", function(t, i) {
        ...
        function i() {
            ...
            A ? o(t) : (t.appear(), t.on("appear", function(e, t) {
                o(t)
            }), e.force_appear())
        }
        ...
        function c() {
            var t = e(".calendar-busy", "#calendar"),
            ...
            t.length > 0 && (B = {
                ...
                initWeekNames: function() {
                    "monday" == B.weekStart && (B.weekNames = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"]);
                ...
                createMonthHtml: function(e, t) {
                    var i = "",
                        ...
                        s = [];
                    "monday" == B.weekStart && (0 == o ? o = 6 : o -= 1), r.empty().html(this.monthNames[t]), l.empty().html(e);
                    ...
                    for (var d = 0; 42 > d; d++) {
                        var c = "";
                        e == this.currentYear && t == this.currentMonth && d - o + 1 == this.currentDay && (c += "current-day"), _(s, d - o + 1) && (c += " busy-day"), d % 7 == 0 && (i += "<tr>"), i += o > d || d >= o + this.getDaysInMonth(e, t) ? '<td class="calendar-other-month"><span></span></td>' : '<td class="calendar-current-month"><span class="' + c + '">' + (d - o + 1) + "</span></td>", d % 7 == 6 && (i += "</tr>")
                    }
                    n.empty().append(i)
                },
                nextMonth: function() {
            ...
            }, B.active.year = B.currentYear, B.active.month = B.currentMonth, B.limitUp.year = B.currentYear + 1, B.limitUp.month = B.currentMonth, B.limitDown.year = B.currentYear, B.limitDown.month = B.currentMonth, B.weekStart = t.data("weekstart"), B.busyDays = W, B.init(), t.on(D, ".calendar-prev", function() {
                B.prevMonth()
            }), t.on(D, ".calendar-next", function() {
                B.nextMonth()
            }))
        }
        ...
        function p() {
            clearInterval(L), setInterval(function() {
                s()
            }, u())
        }
        ...
        function f() {
            var t = e(".nav a[href*=#]");
            t.on("click", function() {
                if (e(this).parents(".mobile-nav").length ? T() : e(this).parents(".nav-wrap").length && (t.parent().removeClass("active"), e(this).parent().addClass("active")), location.pathname.replace(/^\//, "") == this.pathname.replace(/^\//, "") && location.hostname == this.hostname) {
                    var i = e(this.hash),
                        n = this.hash.slice(1);
                    if (i = i.length && i || e("[name=" + n + "]"), i.length) {
                        var o = i.offset().top;
        ...
        function g(e, t) {
            for (R = "", e = e.match(/.{1,2}/g), N = 0; N < e.length; N++) "##" == e[N] ? R += " " : "$$" == e[N] ? R += "\n" : (H = parseInt(e[N]) - t, R += 32 == H ? "://" : 33 == H ? "." : 34 == H ? "-" : 35 == H ? "!" : 36 == H ? "," : O[H]);
            return R
        }

        function v() {
            var t = e(".header");
            e(window).width() > 767 && !A ? (z < F.outerHeight() && (z = F.outerHeight(), t.css("min-height", z + "px")), e(window).scrollTop() > F.outerHeight() ? F.addClass("head-sticky") : F.removeClass("head-sticky")) : (F.removeClass("head-sticky"), t.css("min-height", "0px"))
        }
        ...
        function C() {
            e("body").addClass("mobile-nav-opened"), x()
        }

        function T() {
            e("body").removeClass("mobile-nav-opened"), S()
        }

        function k() {
            e("body").addClass("sidebar-opened"), x()
        }

        function j() {
            e("body").removeClass("sidebar-opened"), S()
        }
        ...
        e(window).resize(function() {
            var t = function() {
                ...
                i = e(window).width(),
                n = e(window).height();
            ($ != i || U != n) && (window.clearTimeout(V), V = window.setTimeout(t, 10)), $ = i, U = n
            ...
            var g = e(".clients-carousel");
            if (g.length > 0)
                for (var o = 0; o < g.length; o++) e(g[o]).owlCarousel({
                    singleItem: !1,
                    autoPlay: !1,
                    stopOnHover: !0,
                    responsive: !0,
            ...
            var x = e(".post-media audio");
            x.length > 0 && x.mediaelementplayer({
                loop: !1,
                audioHeight: 40,
                startVolume: .7
            });
            var S = e(".post-media video");
            S.length > 0 && S.mediaelementplayer({
                loop: !1,
            ...
            for (var _ = e(".input-field input, .input-field textarea"), o = 0; o < _.length; o++) e(_[o]).val() ? e(_[o]).parent(".input-field").addClass("used") : e(_[o]).parent(".input-field").removeClass("used");
            _.on("blur", function() {
                e(this).val() ? e(this).parent().addClass("used") : e(this).parent().removeClass("used")
            }), _.on("focus", function() {
                e(this).parent().addClass("used")
            }), e(document).on(D, ".ripple", function(t) {
                M(e(this), t.pageX, t.pageY)
            }), e(document).on(D, ".ripple-centered", function() {
            ...
            if (L.length > 0) {
                ...
                if (z.length > 0) {
                    var B = z.find("button"),
                        W = e(".filter-btn-group button:first-child");
                    h(A, W), W.addClass("active"), B.on("click", function() {
                        B.removeClass("active"), e(this).addClass("active"), e(".grid-box").addClass("animated"), h(A, e(this))
                    })
                }
                var O = 0,
                    R = 0,
                ...
                V.on("click", function() {
                    e.ajax({
                        ...
                        dataType: "html",
                        beforeSend: function() {
                            V.css("display", "none"), $.css("display", "inline-block")
                        },
                        success: function(t) {
                            if (O = e.grep(e.parseHTML(t), function(t, i) {
                                    return e(t).hasClass("grid-item")
                                }).length, O > R)
                                for (var i = 1; H >= i; i++) {
                                    var n = e(t).filter(".grid-item:eq(" + R + ")");
                                    L.append(n).isotope("appended", n), R++
                                }
                            R >= O && N.hide(), V.css("display", "inline-block"), $.css("display", "none")
                        }
                    })
                });
                var U;
                e(".portfolioFancybox").fancybox({
                    ...
                    beforeShow: function() {
                        ...
                        console.log(t);
                        var i = e(".fancybox-portfolio " + t),
                            n = i.find(".inline-embed");
                        if (n.length > 0) {
                            var o = n.data("embed-type");
                            console.log(o);
                            var s = n.data("embed-url");
                            switch (console.log(s), o) {
                                case "image":
                                ...
                                case "iframe":
                                    ...
                                    break;
                                case "video":
                                    U = "", n.addClass("inline-embed-video");
            ...
            m(), f(), e(".nav-wrap .nav").length > 0 && e(".nav-wrap .nav > ul > li > a").append("<span></span>"), F = e(".head-bar"), F.length > 0 && (F.addClass("animated"), v(), e(window).scroll(function() {
                v()
            })), v(), e(document).on(D, ".btn-mobile", function() {
                e("body").hasClass("mobile-nav-opened") ? T() : C()
            }), e(".mobile-nav").length > 0 && e(".mobile-nav-inner").mCustomScrollbar({
                theme: "dark"
            }), e(document).on(D, ".btn-sidebar", function() {
                e("body").hasClass("sidebar-opened") ? j() : k()
            }), e(".sidebar-fixed").length > 0 && e(".widget-area").mCustomScrollbar({
                theme: "dark"
            }), e(document).on(D, "#overlay", function() {
                e("body").hasClass("mobile-nav-opened") && T(), e("body").hasClass("sidebar-opened") && j()
            }), e("#map").length > 0 && w();
            var q = e(".blog-grid");
            if (q.length > 0) {
                var Y = q.isotope({
                ...
                Y.imagesLoaded().progress(function() {
                    Y.isotope("layout")
                })
            }
            var X = e(".btn-scroll-top");
            e(window).scroll(function() {
                e(this).scrollTop() > 100 ? X.fadeIn() : X.fadeOut()
            }), X.on("click", function() {
                return e("html, body").animate({
                    scrollTop: 0
                }, 800), !1
            }), e(".contact-submit").on("click", function(t) {
                M(e(this).parent(), t.pageX, t.pageY);
                ...
                return o.removeClass("error"), i = !1, "" === s.val() && (i = !0, s.parent().addClass("error")), "" !== a.val() && E(a.val()) || (i = !0, a.parent().addClass("error")), "" === r.val() && (i = !0, r.parent().addClass("error")), i || e.post("php/contact_form.php", n.serialize(), function(e) {
                    l.html(e)
                }), !1
            }), b(), y()
        })
